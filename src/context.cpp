...
Status Context::loadBackend(std::string_view path) {
    ...
    auto fn = reinterpret_cast<BackendCreateFn>(GetProcAddress(handle, "kinet_gpu_create_backend"));
    ...
    auto fn = reinterpret_cast<BackendCreateFn>(dlsym(handle, "kinet_gpu_create_backend"));
